...
const ALL_WORLD_COUNTRIES_RAW = [
  ...
  { code: 'AG', name: 'Antigua & Barbuda', continent: 'North America' },
  ...
  { code: 'BQ', name: 'Bonaire, Sint Eustatius & Saba', continent: 'North America' },
  ...
  { code: 'CC', name: 'Cocos (Keeling) Islands', continent: 'Oceania' },
  { code: 'CO', name: 'Colombia', continent: 'South America' },
  { code: 'KM', name: 'Comoros', continent: 'Africa' },
  { code: 'CG', name: 'Congo - Brazzaville', continent: 'Africa' },
  { code: 'CD', name: 'Congo - Kinshasa (DRC)', continent: 'Africa' },
  ...
  { code: 'CZ', name: 'Czechia (Czech Republic)', continent: 'Europe' },
  ...
  { code: 'SZ', name: 'Eswatini (Swaziland)', continent: 'Africa' },
  ...
  { code: 'HM', name: 'Heard & McDonald Islands', continent: 'Antarctica' },
  { code: 'VA', name: 'Holy See (Vatican City)', continent: 'Europe' },
  { code: 'HN', name: 'Honduras', continent: 'North America' },
  { code: 'HK', name: 'Hong Kong SAR China', continent: 'Asia' },
  ...
  { code: 'MO', name: 'Macao SAR China', continent: 'Asia' },
  ...
  { code: 'PS', name: 'Palestinian Territories', continent: 'Asia' },
  ...
  { code: 'BL', name: 'St. Barthélemy', continent: 'North America' },
  { code: 'SH', name: 'St. Helena', continent: 'Africa' },
  { code: 'KN', name: 'St. Kitts & Nevis', continent: 'North America' },
  { code: 'LC', name: 'St. Lucia', continent: 'North America' },
  { code: 'MF', name: 'St. Martin', continent: 'North America' },
  { code: 'PM', name: 'St. Pierre & Miquelon', continent: 'North America' },
  { code: 'VC', name: 'St. Vincent & Grenadines', continent: 'North America' },
  { code: 'WS', name: 'Samoa', continent: 'Oceania' },
  { code: 'SM', name: 'San Marino', continent: 'Europe' },
  { code: 'ST', name: 'São Tomé & Príncipe', continent: 'Africa' },
  ...
  { code: 'GS', name: 'South Georgia & South Sandwich Islands', continent: 'Antarctica' },
  ...
  { code: 'SJ', name: 'Svalbard & Jan Mayen', continent: 'Europe' },
  ...
  { code: 'UM', name: 'U.S. Outlying Islands', continent: 'Oceania' },
  ...
  { code: 'WF', name: 'Wallis & Futuna', continent: 'Oceania' },
...
const FEATURED_CODES = new Set(['TZ', 'KE', 'UG', 'US', 'GB', 'NG', 'ZA', 'GH', 'RW', 'BR', 'CA', 'FR', 'DE', 'AU', 'IN', 'ES', 'MX']);

const ALL_WORLD_COUNTRIES = ALL_WORLD_COUNTRIES_RAW.map(c => ({
  code: c.code,
  name: c.name,
  flagEmoji: getFlagEmoji(c.code),
  continent: c.continent,
  isFeatured: FEATURED_CODES.has(c.code)
})).sort((a, b) => a.name.localeCompare(b.name));

function updateCountries() {
  console.log(`Generated ${ALL_WORLD_COUNTRIES.length} world countries.`);

  // Update db.json
  if (fs.existsSync(DB_FILE)) {
    const db = JSON.parse(fs.readFileSync(DB_FILE, 'utf-8'));
    db.countries = ALL_WORLD_COUNTRIES;
    fs.writeFileSync(DB_FILE, JSON.stringify(db, null, 2), 'utf-8');
    console.log('Updated db.json with all world countries.');
  }
}
